import MemberViewSwitcher from '@/components/member-view-switcher';
...
const Index = ({ queryParams, users }: IndexProps) => {
    const page = users.meta.current_page;
    console.log(users);
                ...
                <div className="border-sidebar-border/70 dark:border-sidebar-border bg-card text-card-foreground relative min-h-[100vh] flex-1 overflow-auto rounded-xl border md:min-h-min">
                    ...
                    <div className="flex w-full flex-col space-y-1.5">
                        <div className="w-full">
                            <MemberViewSwitcher queryParams={queryParams ?? null} users={users} page={page} />
                        </div>
                    </div>
                </div>
            </div>
